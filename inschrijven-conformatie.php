...
if($classroom == null)
{
    $emailResult = sendConfirmationMail($email, $firstname . ' ' . $lastname, 'noclassroom', longDateNoTime($datetime['NachtVanCuijkDate']), noDateWithTime($datetime['NachtVanCuijkDate']));
}else{
    $emailResult = sendConfirmationMail($email, $firstname . ' ' . $lastname, $classroom, longDateNoTime($datetime['NachtVanCuijkDate']), noDateWithTime($datetime['NachtVanCuijkDate']));
}
